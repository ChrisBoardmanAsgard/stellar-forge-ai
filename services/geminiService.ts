...
const responseSchema = {
    ...
    properties: {
        inventionText: { 
            type: Type.STRING,
            description: "The full markdown text for the invention, including name, summary, features, description, math, and feasibility analysis."
        },
        chartData: {
            type: Type.OBJECT,
            properties: {
...
export const generateInvention = async (userInput: string): Promise<InventionOutput> => {
...
**Your Tasks:**
1.  **Generate a detailed textual concept** for a single, cohesive invention. Structure your response clearly using markdown. This text should be the value for the \`inventionText\` key in the final JSON. The markdown should follow this structure:
